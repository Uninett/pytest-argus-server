# pytest-argus-server documentation build configuration file, created by
...
project = "pytest-argus-server"
copyright = "2015, Morten Brekkevold"
...
man_pages = [
    (
        ...
        "pytest-argus-server Documentation",
        [author],
        1,
    )
]
